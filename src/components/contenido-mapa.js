...
const Mapa = () => {
    ...
    <h2 css={css`text-align:center; font-family: 'Pacifico',cursive;`}>Ubicacion</h2>
        <div css={css`text-align:center;`} className="row">
            <div css={css`font-size:2rem; font-family: 'Pacifico', cursive; `} className="col"><p css={css`color:#F53429;`}>Horario:</p><p>Martes-Domingo: 12:00pm-8:00pm</p></div>
            <div css={css`font-size:2rem; font-family: 'Pacifico', cursive; `}className="col"><p css={css`color:#F53429;`}>Telefono para reservas:</p><p>(55) 48 70 17 98 </p></div>
        </div>
    </div>
